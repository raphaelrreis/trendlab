...
from trendlab.domain.models import Prediction, MarketInsight
...
class ReportGenerator:
    ...
    def generate_markdown(
        ...
        content = [
            ...
            "",
            "## ⚠️ Disclaimer",
            "> **NOT FINANCIAL ADVICE.** This report is generated by an automated ML pipeline for informational purposes only. "
        ...
        for ins in insights:
            icon = "🟢" if ins.trend == "UP" else "🔴" if ins.trend == "DOWN" else "🟡"
        ...
        content.append("|-------|-------|------------|----------|--------|")
        for ins in insights:
            content.append(f"| {ins.asset} | {ins.trend} | {ins.volatility_state} | {ins.drawdown_pct:.1%} | {ins.regime} |")
        ...
        for p in predictions:
            ...
            content.append(f"| {p.asset} | {p.model_name} | {p.horizon_days}d | {p.probability_up:.1%} | {p.signal} | {conf_str} |")
